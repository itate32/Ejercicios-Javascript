...
const botonRes = documento.getElementById("boton");
const resultadoTest = documento.getElementById("resultado");
const preguntas = [
    {
...
function mostrarResultado(){
    ...
    resultadoTest.innerHTML = 'Ha respondido correctamente ' + respuestasCorrectas + ' preguntas de un total de ' + preguntas.length;
}
